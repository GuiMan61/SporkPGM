...
import io.sporkpgm.module.modules.filter.AppliedRegion.AppliedValue;
...
import io.sporkpgm.module.modules.region.types.*;
import io.sporkpgm.module.modules.region.types.groups.ComplementRegion;
import io.sporkpgm.module.modules.region.types.groups.IntersectRegion;
import io.sporkpgm.module.modules.region.types.groups.NegativeRegion;
...
public class RegionBuilder extends Builder {
	...
	public static AppliedRegion parseFiltered(SporkMap map, Element element) throws InvalidRegionException {
		...
		for(AppliedValue key : AppliedValue.values()) {
			...
			}/* else if(key.getReturns() == KitModule.class) {
